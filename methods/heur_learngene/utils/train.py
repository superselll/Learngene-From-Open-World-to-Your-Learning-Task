...
def train(train_loader, model, criterion, optimizer, epoch, cuda, snapshot, name):
...
def train_ewc(train_loader, model, criterion, optimizer, epoch, cuda, snapshot, name, fisher_estimation_sample_size=128):
...
def test_ewc(test_loader, model, criterion, optimizer, epoch, cuda, snapshot, name, fisher_estimation_sample_size=128):
