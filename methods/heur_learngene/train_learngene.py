...
def heru_train(data_name, path, batch_size = 64, epochs = 100, lr = 0.001, momentum = 0.9, no_cuda = False,
               seed = 1, num_works = 21, lr_drop = 0.4, epochs_drop = 110, judgement = False):
    # print result.txt
...
heru_train('imagenet100', r"D:\Personal\Desktop\1\YuanMou\YuanMou\learngene\datasets\exp_data\data_imagenet\2023-12-09_02_55_38\continualdataset")
